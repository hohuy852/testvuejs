  ...
  <div class="relative mt-36 bg-band-story pb-170">
    ...
    <div class="flex flex-col  xl:flex-row justify-center relative z-50 ">
      ...
      <div class="h-auto w-auto border-4 border-black sm:border-l-0 bg-white">
        <div class="pl-11 pr-16">
          <div class="text-ban-title font-extrabold uppercase mt-9">
            What Happened’s Brand story
          </div>
          <div class="font-korean font-light text-ban-paragraph max-w-lg">
